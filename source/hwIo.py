...
class Hid(IoBase):
	...
	def __init__(self, path, onReceive, exclusiveAccess=True):
		"""Constructor.
		...
		@type onReceive: callable(str)
		@param exclusiveAccess: Whether to block other application's access to this device.
		@type exclusiveAccess: bool
		"""
		if _isDebug():
		...
		handle = CreateFile(
			...
			0 if exclusiveAccess else winKernel.FILE_SHARE_READ|winKernel.FILE_SHARE_WRITE,
			None,
